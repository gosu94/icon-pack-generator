...
RUN mkdir -p /app/data/user-letterpacks && chown app:app /app/data/user-letterpacks
...
RUN mkdir -p /app/static/user-letterpacks && chown app:app /app/static/user-letterpacks
